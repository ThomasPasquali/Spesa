...
module.exports = {
    ...
    getLista : function(listaID) {
        return db.query('SELECT l.ID, l.Nome, s.Nome Supermercato, l.Richiedi_prezzi, l.Aperta, l.Gruppo FROM liste l JOIN supermercati s ON s.ID = l.Supermercato WHERE l.ID = ?', [listaID]);
    },
